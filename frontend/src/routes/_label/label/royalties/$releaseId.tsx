// src/routes/_label/label/royalties/$releaseId.tsx
...
export const Route = createFileRoute('/_label/label/royalties/$releaseId')({
...
function ReleaseRoyaltiesDetailPage() {
  ...
  if (error || !release) {
    return (
      <div className='mx-auto py-12 max-w-2xl text-center container'>
        ...
        <Button onClick={() => navigate({ to: '/label/royalties' })} variant='outline'>
  ...
  return (
    <div className='mx-auto py-8 max-w-5xl container'>
      ...
      {/* Summary section (could be expanded later) */}
