...
import { useUserWithDetails, useDeleteUser, useUpdateUser } from '@/hooks/use-user-detail-hooks';
...
function UserDetailPage() {
  ...
  const { data: user, isLoading, isError, error, refetch } = useUserWithDetails(userId);
  ...
  const getBadgeColor = (type: UserType) => {
    switch (type) {
      ...
      case 'LABEL': return 'bg-yellow-100 text-yellow-800';
        ...
        <Card>
          <CardHeader>
            <div className="flex justify-between items-start">
              ...
              <Badge className={getBadgeColor(user.type)}>
                {user.type}
              </Badge>
            </div>
          </CardHeader>
              ...
              <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="space-y-2 text-muted-foreground">
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">{user.artistDetails.name}</span>
                      </div>
                      <div className="flex justify-between">
                        <span>Real Name:</span>
                  ...
                  <div>
                    ...
                    <div className="space-y-2 text-muted-foreground">
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">{user.labelDetails.contactName}</span>
                      </div>
                      <div className="flex justify-between">
                        <span>Country:</span>
                ...
                {user.type === 'MODERATOR' && (
                  <div>
                    ...
                    <div className="text-muted-foreground">
                      This user has moderator privileges and can review releases and content.
                    </div>
                  </div>
                )}
                ...
                {user.type === 'ADMIN' && (
                  <div>
                    ...
                    <div className="text-muted-foreground">
                      This user has full administrative privileges over the entire system.
                    </div>
                  </div>
                )}
                ...
                {user.type === 'PLATFORM' && (
                  <div>
                    ...
                    <div className="text-muted-foreground">
                      This user represents a distribution platform in the system.
                    </div>
                  </div>
                )}
              </div>
