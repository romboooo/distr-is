...
export function UploadCoverButton({ releaseId }: { releaseId: number }) {
  ...
  const { mutate: uploadCover, isPending: isUploading } = useUploadReleaseCover();
        ...
        <div className="py-4">
          {preview ? (
            ...
            <div
              ...
              onDrop={handleDrop}
              className={`relative border-2 border-dashed rounded-lg p-12 text-center transition-colors cursor-pointer ${isDragging
