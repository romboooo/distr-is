            ...
            userData.labelDetails ? (
              <>
                <div>
                  ...
                  <p className='mt-1 font-medium'>
                    {userData.labelDetails.contactName || 'N/A'}
                  </p>
                </div>
                <div>
                  <Label className='text-muted-foreground'>Country</Label>
                  <p className='mt-1 font-medium'>
                    {userData.labelDetails.country || 'N/A'}
                  </p>
                </div>
                <div>
              ...
              <>
                ...
                <div>
                  <Label className='text-muted-foreground'>Label Name</Label>
                  <p className='mt-1 font-medium'>
                    {getArtistLabelName(userData) || 'N/A'}
                  </p>
                </div>
          ...
          <div className='space-y-4'>
            <div className='bg-destructive/10 p-4 border border-destructive/20 rounded-lg'>
              ...
              <p className='mt-1 text-muted-foreground text-sm'>
                You don&apos;t have a label yet. Create a self-label to start
                managing your releases independently.
              </p>
            </div>
            ...
            <SelfLabelCreationDialog
              userId={userData.id}
              artistDetails={
                userData.type === 'ARTIST' ? userData.artistDetails : undefined
              }
            ...
            <Button
              ...
              className='w-full'
              onClick={() =>
                toast.info('Feature coming soon: Sign with existing label')
              }
              disabled
            >
