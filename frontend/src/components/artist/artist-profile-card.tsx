  ...
  return (
    <Card className="lg:col-span-2">
      <CardHeader>
        ...
        <CardDescription>Manage your artist information and releases</CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        <div className="gap-4 grid grid-cols-1 md:grid-cols-2">
          ...
          <div>
            ...
            <p className="mt-1 font-medium">{artistDetails?.realName || 'N/A'}</p>
          </div>
          <div>
            <Label className="text-muted-foreground">Country</Label>
            <p className="mt-1 font-medium">{artistDetails?.country || 'N/A'}</p>
          </div>
          <div>
